...
$nome = filter_input(INPUT_POST, "txtNome", FILTER_SANITIZE_STRING); // Filtrar caracteres
$email = filter_input(INPUT_POST, "txtEmail", FILTER_SANITIZE_STRING);
$funcionario = "";
$funcionarioCodigo = filter_input(INPUT_POST, "slFuncionario", FILTER_SANITIZE_NUMBER_INT);

if($funcionarioCodigo){
  $funcionario = $arraynome[$funcionarioCodigo];
}


/*
if(isset($_POST["txtNome"])){ // isset confere se a variável existe
    $nome = $_POST["txtNome"];
}
